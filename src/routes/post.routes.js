...
import { adminHardDelete, appealPost, commentPOst, createPost, deletPost, getAdminDashboardData, getAdminUserPosts, getAllPosts, getUserPost, likePost, restorePost, sharePost, softDeletePost, updatePost } from "../controllers/post.controller.js";
...
router.route("/soft-delete/:postId").patch(verifyToken,isAdmin, softDeletePost)
...
router.route("/admin/dashbord-data").get(verifyToken, isAdmin, getAdminDashboardData)
